...
function ProductPage() {
        ...
        fetch(`http://localhost:8000/product-info?product_id=${productId}`)
            ...
            .then(data => {
                setProductInfo({
                    ...
                    usersAlsoBagged: Object.values(data.usersAlsoBagged),
                    similarProductRecs: Object.values(data.similarProductRecommendations),
    ...
    return (
        <div className="product-page">
          ...
          <div className="productpage-tables">
